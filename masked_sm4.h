...
const unsigned char FK0[4] = { 0xA3,0xB1,0xBA,0xC6 };
const unsigned char FK1[4] = { 0x56,0xAA,0x33,0x50 };
const unsigned char FK2[4] = { 0x67,0x7D,0x91,0x97 };
const unsigned char FK3[4] = { 0xB2,0x70,0x22,0xDC };
...
void Eval_AND_32(char4* input1, char4* input2, char4* xor_result);
...
void decryptSM4(char* ciphertext, char* key, char* plaintext);
#endif // ! MASKED_SM4_H
